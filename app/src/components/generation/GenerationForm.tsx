...
import { DEFAULT_LORA_PARAMS, FREE_LORA_SLOTS, EMPTY_LORA_PARAMS } from '@/lib/workflows/lora-chain'
...
export default function GenerationForm() {
  ...
  const addLoraSlot = () =>
    setParams((p) => ({ ...p, loras: [...(p.loras ?? DEFAULT_LORA_PARAMS), { name: '', strength: 1 }] }))
      ...
      {workflow.supportsLoRA && (
        <div className="space-y-2">
          ...
          <ConfirmDialog
            ...
            description="Every LoRA patches the same weights, so past two they start competing — expect weaker prompt adherence, muddier detail and drifting color. Lowering each one's strength usually helps."
